...
For the implementation of of texture I chose a 4 point star image I found online
and I did some editing of it in GIMP. The texture uses linear filtering.
Getting the vertices was annoying, because my shape has 16 faces, but it wasn't too bad.

Because this lab uses lab 3 as a foundation I included a copy of lab 3's README below.
The below README includes the controls, which can also be found on the webpage.
